                    ...
                    <div class="cart__item d-flex align-center">
                        ...
                        <div class="flex-1">
                            ...
                            <span class="h6 d-block">
                                Mùi hương:
                                <?php
                                        $sql_variant = "SELECT * FROM product_variant WHERE product_id = '" . $order_detail['product_id'] . "' LIMIT 1";
                            ...
                            <span class="cart__quantity h6 d-block">x
                                <?php echo $order_detail['product_quantity'] ?></span>
                        </div>
