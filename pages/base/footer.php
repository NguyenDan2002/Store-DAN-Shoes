                ...
                <div class="col" style="--w-md: 3">
                    <div class="footer__block pd-top">
                        <div class="footer__logo">
                            <img src="./assets/images/logo/logo_DAN_Shoes.png" alt="logo">
                        </div>
                    </div>
                </div>
                <div class="col" style="--w-md: 3">
                    <div class="footer__block pd-top">
                        ...
                        <ul class="block__list">
                            <li class="block__item">SHOWROOM 1: Số 33, Nhổn, Bắc Từ Liêm, Hà Nội</li>
                            <li class="block__item">SHOWROOM 2: Số 22, Đường Cầu Giấy, Cầu Giấy, Hà Nội</li>
                        </ul>
                    </div>
                </div>
                <div class="col" style="--w-md: 3">
                    <div class="footer__block pd-top">
                        ...
                        <ul class="block__list">
                            <ul class="block__list">
                                <li class="block__item">Chính sách mua hàng</li>
                                <li class="block__item">Chính sách bảo mật</li>
                                <li class="block__item">Chính sách bảo hành và đổi hàng</li>
                            </ul>
                        </ul>
                    </div>
                </div>
                        ...
                        <ul class="block__list">
                            <ul class="block__list">
                                <li class="block__item">
                                    <a class="footer__anchor d-flex align-center space-between"
                    ...
                    <div class="footer__subscribe">
                        ...
                        <div class="email-signup__form justify-center d-flex">
                            <div class="w-100 form__container p-relative">
                                <form action="#">
                                    <input class="email-signup__input btn h4 w-100" type="email" placeholder="email"
                                        name="contact">
