        ...
        <div class="row">
            ...
            <div class="w-100 d-flex align-center space-between">
                <div class="order__detail--action">
                    ...
                    ?>
                    <a href="pages/handle/order.php?order_cancel=1&order_code=<?php echo $order_code ?>"
                        class="btn btn__solid" onClick="return confirm('Bạn có muốn hủy đơn hàng này không?')">Hủy đơn
                        hàng</a>
                    <?php
                    } elseif ($order['order_status'] == 3) {
                    ?>
                    <a href="pages/handle/order.php?order_confirm=1&order_code=<?php echo $order_code ?>"
                        class="btn btn__solid" onClick="return confirm('Xác nhận đã nhận được hàng?')">Xác nhận đã nhận
                        hàng</a>
                    <?php
                    } else {
                    ?>
                    ...
                    <a href="index.php?page=my_account&tab=account_order" class="btn anchor">Trở về danh sách đơn
                        hàng</a>
                </div>
