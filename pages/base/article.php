            ...
            <div class="row">
                <div class="col">
                    <div class="article__img--item">
                        <img class="w-100 d-block object-fit-cover"
                            src="admin/modules/blog/uploads/<?php echo $row['article_image'] ?>" alt="image article">
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <ul class="social__items d-flex align-center">
                                    ...
                                    <li class="social__item opacity-50">
                                        <a class="" href="#info-product">
                                            <img class="svg__icon d-block" src="./assets/images/icon/facebook.svg"
                                                alt="" />
                                        </a>
                                    </li>
                                    <li class="social__item opacity-50">
                                        <a class="" href="#">
                                            <img class="svg__icon d-block" src="./assets/images/icon/twitter.svg"
                                                alt="" />
                                        </a>
                                    </li>
                                    <li class="social__item opacity-50">
                                        <a class="" href="#">
                                            <img class="svg__icon d-block" src="./assets/images/icon/instagram.svg"
                                                alt="" />
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <div class="comment__container">
                        ...
                        <div class="comment__items">
                            ...
                            <div class="comment__item">
                                <span
                                    class="comment__content d-block h4"><?php echo $comment_item['comment_content'] ?></span>
                                <span class="comment__info d-block"><?php echo $comment_item['comment_name'] ?> -
                                    <?php echo $comment_item['comment_date'] ?></span>
                            </div>
                            <?php
                            }
                            ?>
                            ...
                            <div class="form__container">
                                <div class="row">
                                    <div class="col" style="--w-md: 6;">
                                        <div class="w-100 form__input">
                                            <input class="btn w-100" type="text" placeholder="Tên" name="comment_name"
                                                value="">
                                        </div>
                                    </div>
                                    <div class="col" style="--w-md: 6;">
                                        <div class="w-100 form__input">
                                            <input class="btn w-100" type="email" placeholder="Email"
                                ...
                                <div class="row">
                                    <div class="col" style="--w-md: 12;">
                                        <div class="w-100 form__input">
                                            <textarea class="btn w-100" placeholder="Nội dung bình luận"
                                                name="comment_content" id="" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
